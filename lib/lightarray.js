...
LightArray.prototype.start = function(){
    this.frameInterval = setInterval(function(){
        ...
        this.writeToRelay(this.getValues());
...
LightArray.prototype.writeToRelay = function(data){
    if (this.getRelay() !== null && this.getRelay() !== undefined){
        this.getRelay().emit('updateAll', {
...
LightArray.prototype.controlUpdate = function(element, ccValue){
    this.update(element, ccValue);
}

LightArray.prototype.noteUpdateLong = function(element, velocity){

}

LightArray.prototype.noteUpdateShort = function(element, velocity){
